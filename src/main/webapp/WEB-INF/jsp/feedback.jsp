...
<div class="container">
  <form action="/feedback1" method="post">
    ...
    <input type="text" id="fname" name="booking_id" placeholder="Your booking id..">
    
    <label for="subject">Provide your feedback here</label>
    <textarea id="subject" name="feedback" value="feedback" placeholder="Write something.." style="height:200px"></textarea>
